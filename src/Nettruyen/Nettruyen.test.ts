...
describe('NetTruyen', function () {
    ...
    describe('getChapters()', function () {
        it.skip('Get Chapter', async () => {
            const data = await nettruyen.getChapters(
                'verndio-su-thi-ve-mong-kiem-60612'
            );
    ...
    describe('getMangaDetails()', function () {
        it.skip('Get Manga Details', async () => {
            const data = await nettruyen.getMangaDetails(
                'verndio-su-thi-ve-mong-kiem-60612'
            );
            expect(data, 'Null').to.be.not.empty;
            console.debug(data);
    ...
    describe('filterUpdatedManga()', function () {
        it.skip('Get Manga Details', async () => {
            nettruyen.filterUpdatedManga(
                ...
                new Date(),
                [
                    'dinh-cap-khi-van-lang-le-tu-luyen-ngan-nam-63226',
                    'tro-thanh-tai-phiet-nho-game-74151',
                    'truoc-khi-vo-dich-ta-no-tinh-qua-nhieu-71614',
                    'chuyen-sinh-vao-the-gioi-vo-lam-74995',
                    'man-cap-tra-xanh-xuyen-khong-thanh-tieu-dang-thuong-62902',
                    'ta-co-the-don-ngo-vo-han-74869',
                    'phap-su-phe-vat-71545',
                    'moi-tuan-ta-co-mot-nghe-nghiep-moi-505430',
                    '66879',
                    '65660',
                    '71030',
                ]
